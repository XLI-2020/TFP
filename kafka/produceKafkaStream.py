...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='Gas', required=False, help='Speed up time series by a given multiplicative factor.')
    parser.add_argument('--ratio', type=float, default=0.9, required=False, help='missing ratio')

    parser.add_argument('--sequence_len', type=int, default=600, required=False, help='the used length of the stream')
    ...
    while cnt <= total_data_length - 1:
        try:
            ...
            time.sleep(1) # sampling interval 1s for observation; others like 100ms, 20ms
            result = {}
